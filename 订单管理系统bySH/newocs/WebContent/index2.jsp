...
<div id="wrap">
<h1>订单管理系统</h1>
<div class="title">你好，业务员
<%=session.getAttribute("username")%>&nbsp！
&nbsp&nbsp
<a href="newtitle.jsp">新增订单</a>
<a href="index.jsp">退出</a>
<br/></div>
<%
List posts = new postcurd().display((String)session.getAttribute("username"));
...
<td><%=pos.getPay() %></td>
<td><%=pos.getSend()%>
<td><a href="addzanaction?title=<%=pos.getTitle()%>">点击发货</a></td>
</tr>
